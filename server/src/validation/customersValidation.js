...
const customerIdValidation = [param('id')
    .isInt({min: 1})
    .withMessage('Customer ID должен быть положительным целым числом'),]

const getAllCustomersValidation = [query('limit')
    .optional()
    .isInt({min: 1, max: 100})
...
const createCustomerValidation = [body('name')
    .isString()
...
const updateCustomerValidation = [...customerIdValidation,
